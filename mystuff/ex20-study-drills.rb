...
# define a function print_all, it takes file object as a parameter
def print_all(f)
  # print the content of the file object (a string)
  puts f.read
end

# define a function rewind, it takes file object as a parameter
def rewind(f)
...
# the file pointer for the current_file is moved to beginning of the file
rewind(current_file)
...
current_line = 1
# the function prints 1, and the first line of the content of current_file
print_a_line(current_line, current_file)

# increment the value of current_line by 1, current_line now is 2
